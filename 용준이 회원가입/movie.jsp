...
<html lang="en">
 ...
 <body style="overflow-x:hidden;">
	...
	<ul>
		...
		<li class = menuright><a href="Leesignjsp.jsp">Signup</a></li>
	...
	<div id =mainwrapper>
		<div id =bookingbox>
			...
			<div id =bookingsecond>
				...
				<div OnClick="location.href ='movie.html'" style="margin-left:20px;cursor:pointer;width:150px;border-radius:10px;
